...
<?php
	$true = true;
	$false= false;	//Notice in a boolean variable you do NOT use quotes for a true or false value
?>
<p>5. Display the trueFalse variable within an string literal using concatenation and within a paragraph element.</p>
<?php
	echo "<p>The trueFalse variable contains " . $false . ". </p>";	//concatenation - joining of multiple parts into a single string
?>
...
<?php
	echo "<p>The trueFalse variable contains $true.</p>";	//concatenation - joining of multiple parts into a single string
?>
